...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x73aa;
...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 720 ; //24 * 60 * 60 / DIFFICULTY_TARGET;
...
const int      P2P_DEFAULT_PORT                              = 18090;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18091;
